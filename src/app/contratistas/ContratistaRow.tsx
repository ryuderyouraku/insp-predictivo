...
import { deleteContratista } from '@/server/actions/contratistas'
import type { Contratista } from '@prisma/client'

export function ContratistaRow({ contratista }: { contratista: Contratista }) {
  ...
  return (
    <li className="rounded border bg-white p-3">
      <div className="flex items-center gap-3">
        ...
        <span className="flex-1">{contratista.nombre}</span>
        {!confirming ? (
          <button
